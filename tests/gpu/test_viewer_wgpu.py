...
from mojive.app.composition import build_scene  # noqa: E402
from mojive.app.demos import canvas_scene  # noqa: E402
...
def test_owned_imgui_render_path(viewer):
    # Ordinary UI reuses bounded upload buffers across frames.
    v, _scene = viewer
    v.sync()
    assert float(viewport_snap(v).std()) > 10.0
