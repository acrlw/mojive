...
from mojive.app.composition import Viewer
...
def test_explicit_adapter_and_renderer_selection_reaches_composition(monkeypatch, tmp_path):
    ...
    from mojive.app import composition as composition
    ...
    monkeypatch.setattr("mojive.app.backends.make_adapter", registry.make_adapter)
