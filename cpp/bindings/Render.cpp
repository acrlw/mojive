...
void bindRender(nb::module_ &module) {
    ...
    nb::class_<FrameStats>(module, "FrameStats")
        ...
        .def_ro("color_triangles", &FrameStats::colorTriangles)
        .def_ro("shadow_triangles", &FrameStats::shadowTriangles)
        .def_ro("data_triangles", &FrameStats::dataTriangles)
        .def_ro("lod_instances", &FrameStats::lodInstances)
        .def_ro("lod_meshes_ready", &FrameStats::lodMeshesReady)
        .def_ro("lod_meshes_pending", &FrameStats::lodMeshesPending);
    ...
    nb::class_<SceneStyle>(module, "SceneStyle")
        ...
        .def_rw("mesh_lod", &SceneStyle::meshLod)
    ...
    nb::class_<SceneSource>(module, "SceneSource")
        ...
        .def_rw("retained_lod_meshes", &SceneSource::retainedLodMeshes)
