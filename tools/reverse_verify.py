...
CPU_TESTS = "python/tests/test_scene.py"
CAM_TESTS = "python/tests/test_camera.py"
VC_TESTS = "python/tests/test_viewcube.py"
REFL_TESTS = "python/tests/test_reflection.py"
REFL_GPU = "python/tests/gpu/test_reflection.py"
GPU_TESTS = "python/tests/gpu/test_opengl_core.py"
UI_TESTS = "python/tests/gpu/test_ui_interaction.py"


CASES = [
    (
        "python/src/mojive/render/opengl/targets.py",
    ...
    (
        "python/src/mojive/render/opengl/instances.py",
        "                start * stride,",
        "                0,",
    ...
    (
        "python/src/mojive/render/opengl/state_guard.py",
    ...
    (
        "python/src/mojive/render/opengl/programs.py",
    ...
    (
        "python/src/mojive/render/opengl/timing.py",
    ...
    (
        "python/src/mojive/render/scene.py",
    ...
    (
        "python/src/mojive/render/opengl/passes/reflect.py",
        '        gl.front_face = "cw"',
        "        pass",
    ...
    (
        "python/src/mojive/render/opengl/shaders/scene_body.glsl",
    ...
    (
        "python/src/mojive/ui/app/input.py",
    ...
    (
        "python/src/mojive/ui/viewcube.py",
    ...
    (
        "python/src/mojive/ui/app/navigation.py",
    ...
    (
        "python/src/mojive/ui/gizmo/drawing.py",
        "            and not yielding\n            and (self._verdict.ok or self._display_only)",
        "            and not yielding\n            and interactive and (self._verdict.ok or self._display_only)",
        "test_gizmo_stays_drawn_while_the_camera_is_being_dragged",
        UI_TESTS,
    ),
    (
        "python/src/mojive/ui/theme.py",
        '    "x": rgb8(220, 119, 115),',
        '    "x": (0.666, 0.0, 0.0, 1.0),',
    ...
    (
        "python/src/mojive/ui/gizmo/dragging.py",
    ...
    (
        "python/src/mojive/ui/gizmo/targets.py",
    ...
    (
        "python/src/mojive/ui/camera.py",
...
def run(test: str, path: str) -> int:
    marks = "gpu" if path.startswith("python/tests/gpu") else "not gpu"
    env = dict(os.environ)
