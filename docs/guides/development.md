...
| UI geometry | Share production painters, hit bounds, layout and focus geometry with prototypes and panels. | Copy drawing formulas into another caller or maintain a visually similar second implementation. |
