...
from .chrome import draw_keycap_background, draw_separator
from .model import (
...
def _keycap(
    ...
    *,
    ...
    draw_keycap_background(
        draw, (x, y), width, height, theme.bg_frame, theme.border, scale, rounding
    )
    draw.text(
