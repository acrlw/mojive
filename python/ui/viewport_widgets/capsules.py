...
from .chrome import capsule_points as capsule_points
from .chrome import draw_capsule_shell, draw_selection_disc, draw_separator
from .glyphs import (
    _pause_icon,
    _play_icon,
    _previous_icon,
...
def draw_capsule(
    ...
    draw_capsule_shell(
        draw, origin, width, height, theme.viewport.surface, theme.viewport.outline, 1.4 * scale
    )
...
def draw_overlay_divider(
    ...
    *,
    ...
    x, y = center
    draw_separator(draw, (x - dx, y - dy), (x + dx, y + dy), theme.viewport.divider, scale)
