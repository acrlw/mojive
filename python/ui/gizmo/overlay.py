"""Gizmo overlays and render-command publication."""
...
from mojive.geometry2d.curves import arc_ribbon_mesh, smooth_affine_corners
...
class _Overlay:
    """Private overlay methods of ObjectGizmo; state belongs to its owner."""
