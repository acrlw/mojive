...
from mojive.adapters.base import CAMERA_OBJECT_BASE
from mojive.scene import Scene
from mojive.scene.model import _CameraItem, _immutable_mesh, _Item, _LightItem
        ...
        objects.append(
            {
                ...
                "color": item.rgba.tolist(),
                "inherit_material_color": item.color is None,
...
def _scene_from_document(document: dict) -> Scene:
    ...
    scene._items = [
        _Item(
            ...
            color=None if item.get("inherit_material_color", False) else _f32(item["color"], (4,)),
