...
from mojive.adapters.base import FrameNeeds, SceneFrame, SceneProvider, SceneSource
...
class SceneRenderer:
    ...
    def set_contact_style(self, style: ContactStyle) -> bool:
        """Set contact marker shape, color, and size without changing physics."""
        with self._current():
            return self._backend.set_contact_style(style)
