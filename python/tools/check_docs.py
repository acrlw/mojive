...
PUBLIC_MODULES = (
    "python/types.py",
    "python/commands.py",
    "python/adapters/base.py",
    "python/adapters/conformance.py",
    "python/scene/model.py",
    "python/app/composition.py",
    "python/session/core.py",
    "python/app/renderer.py",
    "python/render/backend.py",
    "python/render/debugdraw.py",
    "python/capture/recording.py",
    "python/remote/adapter.py",
    "python/remote/protocol.py",
    "python/remote/publisher.py",
    "python/remote/commands.py",
    "python/control/rpc/client.py",
    "python/control/rpc/service.py",
    "python/control/rpc/server.py",
    "python/control/rpc/viewer.py",
    "python/control/contracts.py",
    "python/scene/io.py",
    "python/scene/workspace.py",
)
