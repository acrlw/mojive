...
CASES = [
    (
        "python/render/opengl/targets.py",
    ...
    (
        "python/render/opengl/instances.py",
        "                start * stride,",
        "                0,",
    ...
    (
        "python/render/opengl/state_guard.py",
    ...
    (
        "python/render/opengl/programs.py",
    ...
    (
        "python/render/opengl/timing.py",
    ...
    (
        "python/render/opengl/passes/reflect.py",
        '        gl.front_face = "cw"',
        "        pass",
    ...
    (
        "python/render/opengl/shaders/scene_body.glsl",
