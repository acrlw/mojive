...
"""
    ...
    assert (destination / "mojive/native_licenses/stbImageResize.txt").is_file()
    assert (destination / "mojive/native_licenses/meshoptimizer.txt").is_file()
    assert (destination / "mojive/native_licenses/libtess2.txt").is_file()
