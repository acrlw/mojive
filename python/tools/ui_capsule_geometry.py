...
from mojive.ui.viewport_widgets.chrome import draw_capsule_shell as _draw_capsule_shell
...
def draw_capsule_shell(draw, x, y, width, height, scale, geometry):
    _draw_capsule_shell(
        ...
        capsule_outline_color(geometry),
        1.4 * scale,
        smoothing=geometry.capsule_smoothing,
    )
