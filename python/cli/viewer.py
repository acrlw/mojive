...
from .control import _viewer_rpc_options


def cmd_view(args: argparse.Namespace) -> int:
    from mojive.app.composition import build, build_workspace
...
def cmd_canvas(args: argparse.Namespace) -> int:
    ...
    from mojive.app.demos import canvas_scene, lighting_scene
...
def cmd_editor(args: argparse.Namespace) -> int:
    from mojive.app.composition import build_editor, build_workspace
