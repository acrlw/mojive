...
_HANDLERS = {
    ...
    cmd.CreateStateTake: playback.create_state_take,
    cmd.SelectStateTake: playback.select_state_take,
    cmd.RemoveStateTake: playback.remove_state_take,
    cmd.DeleteStateTakeFrames: playback.delete_state_take_frames,
    cmd.StopStateTakeRecording: playback.stop_state_take_recording,
    cmd.PlayStateTake: playback.play_state_take,
    cmd.SetStateTakePauseAtEnd: playback.set_state_take_pause_at_end,
